...
async def warn(interaction: discord.Interaction, user: Member, reason: str = None):
    ...
    warn_data = {
        ...
        # 'timestamp' will be auto-generated by Supabase (default now())
    }
    # Insert warn into Supabase (wrap synchronous call in asyncio.to_thread)
    await asyncio.to_thread(lambda: supabase.table("warns").insert(warn_data).execute())

    # Query total warns for the user in this guild
